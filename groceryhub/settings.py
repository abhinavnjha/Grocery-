"""
Django settings for groceryhub project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-y6#51$&u^#1^wbbdqp-x$d+1ypys87+!n_nlj!*&6)w*=ps4(x')
...
WSGI_APPLICATION = 'groceryhub.wsgi.application'
